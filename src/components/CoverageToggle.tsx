        ...
        return (
          <motion.button
            ...
            className={[
              ...
              active ? 'bg-emerald-600 text-white' : 'text-slate-400 hover:text-slate-200 hover:bg-white/[0.05]',
            ].join(' ')}
          >
            {active && (
              <motion.div
            ...
            <span className="relative z-10">
              ...
              <p className={`text-[10px] mt-0.5 leading-tight ${active ? 'text-emerald-200' : 'text-slate-500'}`}>
                {opt.labelCz}
              </p>
            </span>
          </motion.button>
